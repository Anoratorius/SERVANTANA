...
// From email for sending - use Resend's default until domain is verified
const FROM_EMAIL = "Servantana <onboarding@resend.dev>";

// Logo as base64 data URI for email embedding
