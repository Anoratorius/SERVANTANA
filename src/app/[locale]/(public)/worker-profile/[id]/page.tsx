            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  {profile.ecoFriendly && (
                    <Badge variant="secondary" className="bg-emerald-100 text-emerald-800">
                      ...
                      {t("worker.profile.ecoFriendly")}
                    </Badge>
                  )}
                  {profile.petFriendly && (
                    <Badge variant="secondary" className="bg-orange-100 text-orange-800">
                      <PawPrint className="h-3 w-3 mr-1" />
                      {t("worker.profile.petFriendly")}
                    </Badge>
                  )}
                </div>
                ...
                <div className="flex flex-wrap gap-6 mt-4">
                  ...
                  <div className="text-muted-foreground">
                    ...
                    {t("worker.profile.bookings").toLowerCase()}
                  </div>
                  <div className="text-muted-foreground">
                    <span className="font-semibold text-foreground">{profile.experienceYears}</span>{" "}
                    {t("worker.profile.years")} {t("worker.profile.experience").toLowerCase()}
                  </div>
                  {profile.responseTime && (
                    <div className="flex items-center gap-1 text-muted-foreground">
                      <Clock className="h-4 w-4" />
                      <span>
                        {t("worker.profile.responseTime")}: {profile.responseTime} min
                      </span>
                    </div>
                  )}
                </div>
              ...
              <Card className="w-full md:w-64 shrink-0 border-t-4 border-t-green-500">
                <CardContent className="p-6 text-center">
                  <div className="text-muted-foreground text-sm">{t("worker.profile.hourlyRate")}</div>
        ...
        <section className="py-8">
          <div className="container mx-auto px-4">
            <Tabs defaultValue="about" className="space-y-6">
              <TabsList>
                <TabsTrigger value="about">{t("worker.profile.about")}</TabsTrigger>
                <TabsTrigger value="services">{t("worker.profile.services")}</TabsTrigger>
                <TabsTrigger value="reviews">{t("worker.profile.reviews")}</TabsTrigger>
                <TabsTrigger value="availability">{t("worker.profile.availability")}</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="about" className="space-y-4">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>{t("worker.profile.about")}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    {profile.bio ? (
              ...
              <TabsContent value="services">
                <Card>
                  <CardHeader>
                    <CardTitle>{t("worker.profile.services")}</CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="availability">
                <Card>
                  <CardHeader>
                    <CardTitle>{t("worker.profile.availability")}</CardTitle>
                  </CardHeader>
                  <CardContent>
